...
static Node *ll_popFirstOfList(LinkedList *);
static int ll_pushToFirst(LinkedList *, void*);
static Node* ll_createNode(Node *, void *);
...
int ll_push(LinkedList* this, int index, void* pElement)
{
    ...
    Node *newNode = ll_createNode(currentNode->pNextNode, pElement);
...
int ll_print(LinkedList *this) {
    if (ll_isEmpty(this)) {
        return -1;
    }
    Node *temporary = this->pFirstNode;
...
static Node* ll_createNode(Node *next, void *pElement){
